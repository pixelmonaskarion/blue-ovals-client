...
module.exports = { generateKeyPair, decrypt_message, encrypt_message, test, encrypt, decrypt, base64ToArrayBuffer };
...
const decryptDataWithRSAPrivateKey = async (encryptedDataString, privateKey) => {
	...
	const blockSize = privateKey.algorithm.modulusLength;
